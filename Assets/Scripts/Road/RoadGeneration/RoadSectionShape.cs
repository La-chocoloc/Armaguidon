...
namespace JonathonOH.RoadGeneration
{
    ...
    public class RoadSectionShape
    {
        ...
        public List<TransformData> Ends;
        ...
        public RoadSectionShape GetTranslatedCopy(TransformData newHandlePosition)
        {
            ...
            newShape.Start = newHandlePosition;
            newShape.Ends = new List<TransformData>();
            foreach (TransformData end in Ends)
            {
                newShape.Ends.Add(newHandlePosition.TransformPoint(Start.InverseTransformPoint(end)));
            }
